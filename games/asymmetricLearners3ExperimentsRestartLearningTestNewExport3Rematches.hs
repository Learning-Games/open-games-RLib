...
import qualified Examples.QLearning.AsymmetricLearnersThreePhases as Scenario
...
parametersGameRematchingMapPhase2 = fromList [(("e1","e2"),p1e1p2e2),(("e1","e3"),p1e1p2e3),(("e2","e1"),p1e2p2e1),(("e2","e3"),p1e2p2e3),(("e3","e1"),p1e3p2e1),(("e3","e2"),p1e3p2e2),(("e1","e1"),p1e1p2e1),(("e2","e2"),p1e2p2e2),(("e3","e3"),p1e3p2e3)]
...
-- Recreating the initial conditions but with no exploration
parametersGameLowC' :: StdGen -> StdGen -> StdGen -> StdGen -> Scenario.Parameters
parametersGameLowC' gEnv1 gEnv2 gObs1 gObs2 = Scenario.Parameters
  { pKsi = 0.1
  , pBeta =  0.000004
...
parametersGameRematchingMapPhase3 = fromList [(("e1e2","e2e1"),parametersGameLowC'),(("e1e3","e3e1"),parametersGameLowC'),(("e2e1","e1e2"),parametersGameMedC'),(("e2e3","e3e2"),parametersGameMedC'),(("e3e1","e1e3"),parametersGameHighC'),(("e3e2","e2e3"),parametersGameHighC')]


rematchIdsPhase3 = [Scenario.ReMatchType "e1e2" "e2e1" False, Scenario.ReMatchType "e1e3" "e3e1" False, Scenario.ReMatchType "e2e1" "e1e2" False, Scenario.ReMatchType "e2e3" "e3e2" False, Scenario.ReMatchType "e3e1" "e1e3" False, Scenario.ReMatchType "e3e2" "e2e3" False]
