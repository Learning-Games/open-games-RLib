...
import qualified Examples.QLearning.AsymmetricLearners4Phases as Scenario
...
parametersMap exploreRate1 exploreRate2 = fromList [("e1",parametersGameLowC  exploreRate1  exploreRate2),("e2",parametersGameMedC  exploreRate1  exploreRate2),("e3",parametersGameHighC  exploreRate1  exploreRate2) ]

-- Use dummy parameters for extracting the keys
expIds = keys $ parametersMap ((exp 1) ** 0) ((exp 1) ** 0)
...
parametersGameRematchingMapPhase2 exploreRate1 exploreRate2 = fromList [(("e1","e2"),p1e1p2e2  exploreRate1  exploreRate2),(("e1","e3"),p1e1p2e3  exploreRate1  exploreRate2),(("e2","e1"),p1e2p2e1  exploreRate1  exploreRate2),(("e2","e3"),p1e2p2e3  exploreRate1  exploreRate2),(("e3","e1"),p1e3p2e1  exploreRate1  exploreRate2),(("e3","e2"),p1e3p2e2  exploreRate1  exploreRate2),(("e1","e1"),p1e1p2e1  exploreRate1  exploreRate2),(("e2","e2"),p1e2p2e2  exploreRate1  exploreRate2),(("e3","e3"),p1e3p2e3  exploreRate1  exploreRate2)]
...
parametersGameRematchingMapPhase3 exploreRate1 exploreRate2 = fromList [(("e1","e2"),p1e1p2e2  exploreRate1  exploreRate2),(("e1","e3"),p1e1p2e3  exploreRate1  exploreRate2),(("e2","e1"),p1e2p2e1  exploreRate1  exploreRate2),(("e2","e3"),p1e2p2e3  exploreRate1  exploreRate2),(("e3","e1"),p1e3p2e1  exploreRate1  exploreRate2),(("e3","e2"),p1e3p2e2  exploreRate1  exploreRate2),(("e1","e1"),p1e1p2e1  exploreRate1  exploreRate2),(("e2","e2"),p1e2p2e2  exploreRate1  exploreRate2),(("e3","e3"),p1e3p2e3  exploreRate1  exploreRate2)]
...
parametersGameRematchingMapPhase4 exploreRate1 exploreRate2 = fromList [(("e1e2","e2e1"),parametersGameLowC  exploreRate1  exploreRate2),(("e1e3","e3e1"),parametersGameLowC  exploreRate1  exploreRate2),(("e2e1","e1e2"),parametersGameMedC  exploreRate1  exploreRate2),(("e2e3","e3e2"),parametersGameMedC  exploreRate1  exploreRate2),(("e3e1","e1e3"),parametersGameHighC  exploreRate1  exploreRate2),(("e3e2","e2e3"),parametersGameHighC  exploreRate1  exploreRate2)]
...
main = do
  sequence_ $
    fmap (\name -> Scenario.executeAndRematchSingleRun
                    ...
                    (parametersMap ((exp 1) ** 0) ((exp 1) ** 0))
                    keepOnlyNLastIterations
                    (parametersGameRematchingMapPhase2 0 0)
                    (parametersGameRematchingMapPhase3 ((exp 1) ** 0) ((exp 1) ** 0))
                    (parametersGameRematchingMapPhase4 0 0)
