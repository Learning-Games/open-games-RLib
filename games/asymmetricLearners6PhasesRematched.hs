...
parametersGameRematchingMapPhase6 = fromList
  [ (("e1e2e2e3", "e2e3e3e1"), parametersGameLowC 0 0)
  , (("e1e2e2e3", "e3e2e2e1"), parametersGameLowC 0 0)
...
rematchIdsPhase6 = [ Scenario.ReMatchType "e1e2e2e3" "e2e3e3e1" True
                   , Scenario.ReMatchType "e1e2e2e3" "e3e2e2e1" True
