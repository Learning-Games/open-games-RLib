...
import qualified Examples.QLearning.AsymmetricLearnersSixPhases as Scenario
...
parametersGameRematchingMapPhase4 = fromList
  [ (("e1e2", "e2e1"), parametersGameLowC 0 0)
  , (("e1e3", "e3e1"), parametersGameLowC 0 0)
  , (("e2e1", "e1e2"), parametersGameMedC 0 0)
  , (("e2e3", "e3e2"), parametersGameMedC 0 0)
  , (("e3e1", "e1e3"), parametersGameHighC 0 0)
  , (("e3e2", "e2e3"), parametersGameHighC 0 0)]

rematchIdsPhase4 = [ Scenario.ReMatchType "e1e2" "e2e1" False
                   , Scenario.ReMatchType "e1e3" "e3e1" False
                   , Scenario.ReMatchType "e2e1" "e1e2" False
                   , Scenario.ReMatchType "e2e3" "e3e2" False
                   , Scenario.ReMatchType "e3e1" "e1e3" False
                   , Scenario.ReMatchType "e3e2" "e2e3" False]

-- Phase 5; learning phase
parametersGameRematchingMapPhase5 = fromList
  [ (("e1e2", "e2e3"), p1e1p2e3 ((exp 1) ** 0) ((exp 1) ** 0))
  , (("e1e3", "e3e2"), p1e1p2e2 ((exp 1) ** 0) ((exp 1) ** 0))
  , (("e2e1", "e1e3"), p1e2p2e3 ((exp 1) ** 0) ((exp 1) ** 0))
  , (("e2e3", "e3e1"), p1e2p2e1 ((exp 1) ** 0) ((exp 1) ** 0))
  , (("e3e1", "e1e2"), p1e3p2e2 ((exp 1) ** 0) ((exp 1) ** 0))
  , (("e3e2", "e2e1"), p1e3p2e1 ((exp 1) ** 0) ((exp 1) ** 0))]

rematchIdsPhase5 = [ Scenario.ReMatchType "e1e2" "e2e3" False
                   , Scenario.ReMatchType "e1e3" "e3e2" False
                   , Scenario.ReMatchType "e2e1" "e1e3" False
                   , Scenario.ReMatchType "e2e3" "e3e1" False
                   , Scenario.ReMatchType "e3e1" "e1e2" False
                   , Scenario.ReMatchType "e3e2" "e2e1" False]

-- Phase 6; exploitation phase
parametersGameRematchingMapPhase6 = fromList
  [ (("e1e2e3e2", "e2e3e3e1"), parametersGameLowC 0 0)
  , (("e1e2e3e2", "e3e2e2e1"), parametersGameLowC 0 0)
  , (("e1e3e3e2", "e2e3e3e1"), parametersGameLowC 0 0)
  , (("e1e3e3e2", "e3e2e2e1"), parametersGameLowC 0 0)
  , (("e2e1e1e3", "e1e3e3e2"), parametersGameMedC 0 0)
  , (("e2e1e1e3", "e3e1e1e2"), parametersGameMedC 0 0)
  , (("e2e3e3e1", "e1e3e3e2"), parametersGameMedC 0 0)
  , (("e2e3e3e1", "e3e1e1e2"), parametersGameMedC 0 0)
  , (("e3e1e1e2", "e1e2e2e3"), parametersGameHighC 0 0)
  , (("e3e1e1e2", "e2e1e1e3"), parametersGameHighC 0 0)
  , (("e3e2e2e1", "e1e2e2e3"), parametersGameHighC 0 0)
  , (("e3e2e2e1", "e2e1e1e3"), parametersGameHighC 0 0)]

rematchIdsPhase6 = [ Scenario.ReMatchType "e1e2e3e2" "e2e3e3e1" True
                   , Scenario.ReMatchType "e1e2e3e2" "e3e2e2e1" True
                   , Scenario.ReMatchType "e1e3e3e2" "e2e3e3e1" True
                   , Scenario.ReMatchType "e1e3e3e2" "e3e2e2e1" True
                   , Scenario.ReMatchType "e2e1e1e3" "e1e3e3e2" True
                   , Scenario.ReMatchType "e2e1e1e3" "e3e1e1e2" True
                   , Scenario.ReMatchType "e2e3e3e1" "e1e3e3e2" True
                   , Scenario.ReMatchType "e2e3e3e1" "e3e1e1e2" True
                   , Scenario.ReMatchType "e3e1e1e2" "e1e2e2e3" True
                   , Scenario.ReMatchType "e3e1e1e2" "e2e1e1e3" True
                   , Scenario.ReMatchType "e3e2e2e1" "e1e2e2e3" True
                   , Scenario.ReMatchType "e3e2e2e1" "e2e1e1e3" True]
...
exportConfigGameRematchingPhase5 name parameters arr1 arr2 obs = ExportAsymmetricLearners.ExportConfig
    { iterations = 1000000000
    -- ^ how many iterations?
    , incrementalMode = True
    -- ^ report incremental changes to qmatrix or export full qmatrix with each iteration?
...
exportConfigGameRematchingPhase6 name parameters arr1 arr2 obs = ExportAsymmetricLearners.ExportConfig
    { iterations = 1000
    -- ^ how many iterations?
    , incrementalMode = True
    -- ^ report incremental changes to qmatrix or export full qmatrix with each iteration?
...
main = do
  sequence_ $
    fmap (\name -> Scenario.executeAndRematchSingleRun
                    ...
                    parametersGameRematchingMapPhase5
                    parametersGameRematchingMapPhase6
                    exportConfigGameRematchingPhase2
                    exportConfigGameRematchingPhase3
                    exportConfigGameRematchingPhase4
                    exportConfigGameRematchingPhase5
                    exportConfigGameRematchingPhase6
                    expIds
                    rematchIdsPhase2
                    rematchIdsPhase3
                    rematchIdsPhase4
