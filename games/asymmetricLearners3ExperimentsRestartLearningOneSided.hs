...
import qualified Examples.QLearning.AsymmetricLearners as Scenario
...
exportConfigGameRematching name parameters arr1 arr2 obs = ExportAsymmetric.ExportConfig
    { iterations = 1000000000
    -- ^ how many iterations?
    , incrementalMode = True
    -- ^ report incremental changes to qmatrix or export full qmatrix with each iteration?
