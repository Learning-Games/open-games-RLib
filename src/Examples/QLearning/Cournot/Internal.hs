...
module Examples.QLearning.Cournot.Internal
  where
...
instance FastCsv.BuildCsvField (QuantitySpace, QuantitySpace) where
...
instance FastCsv.BuildCsvField QuantitySpace where
