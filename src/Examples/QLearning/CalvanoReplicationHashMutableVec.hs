...
module Examples.QLearning.CalvanoReplicationHashMutableVec
                     ( evalStageLS
                     , initialStrat
                     , beta
                     , actionSpace
...
import           Engine.QLearningHashMutableVec
...
actionSpace = V.fromList [lowerBound,lowerBound+dist..upperBound]
...
createRandomPrice :: V.Vector PriceSpace -> Int -> PriceSpace
