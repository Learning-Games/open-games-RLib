...
module Examples.QLearning.CournotBoltzmann.MarkovInternal
  where

import           Engine.Diagnostics
import           Engine.QLearning.ImportAsymmetricLearners
import           Examples.QLearning.Cournot.Internal (Parameters(..),demand)
...
profit1 par@Parameters {..} q1 q2 = ((demand par q1 q2) - pC1) * q1

-- profit player 2
profit2 :: Parameters -> Action -> Action -> Double
profit2 par@Parameters {..} q1 q2 = ((demand par q1 q2) - pC2) * q2
...
lowerBound1 Parameters{pLowerQuantity1,pKsi,pUpperQuantity1} = pLowerQuantity1 - pKsi*(pUpperQuantity1 - pLowerQuantity1)
upperBound1 Parameters{pLowerQuantity1,pKsi,pUpperQuantity1} = pUpperQuantity1 + pKsi*(pUpperQuantity1 - pLowerQuantity1)
lowerBound2 Parameters{pLowerQuantity2,pKsi,pUpperQuantity2} = pLowerQuantity2 - pKsi*(pUpperQuantity2 - pLowerQuantity2)
upperBound2 Parameters{pLowerQuantity2,pKsi,pUpperQuantity2} = pUpperQuantity2 + pKsi*(pUpperQuantity2 - pLowerQuantity2)
