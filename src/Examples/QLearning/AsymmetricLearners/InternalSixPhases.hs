...
module Examples.QLearning.AsymmetricLearners.InternalSixPhases
  where
...
executeAndRematchSingleRun :: String
                           ...
                           -> [ReMatchType]
                           -> IO ()
executeAndRematchSingleRun name  exportConfigGameLearning parametersMap keepOnlyNLastIterations parametersGameRematchingMapPhase2 parametersGameRematchingMapPhase3 parametersGameRematchingMapPhase4 parametersGameRematchingMapPhase5 parametersGameRematchingMapPhase6 exportConfigGameRematchingPhase2 exportConfigGameRematchingPhase3 exportConfigGameRematchingPhase4 exportConfigGameRematchingPhase5 exportConfigGameRematchingPhase6 expIds rematchTypeIdsPhase2 rematchTypeIdsPhase3 rematchTypeIdsPhase4 rematchTypeIdsPhase5 rematchTypeIdsPhase6= do
  ...
  mapM_ (rematchedLearning ("_phase2_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase2 exportConfigGameRematchingPhase2 (aggMap1Phase1,aggMap2Phase1)) rematchTypeIdsPhase2
  qTablesMapPhase3 <- mapM (rematchedLearning ("_phase3_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase3 exportConfigGameRematchingPhase3 (aggMap1Phase1,aggMap2Phase1)) rematchTypeIdsPhase3
  let aggMap1Phase3 = unions $ fmap fst qTablesMapPhase3
      aggMap2Phase3 = unions $ fmap snd qTablesMapPhase3
  mapM_ (rematchedLearning ("_phase4_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase4 exportConfigGameRematchingPhase4 (aggMap1Phase3,aggMap2Phase3)) rematchTypeIdsPhase4
  qTablesMapPhase5 <- mapM (rematchedLearning ("_phase5_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase5 exportConfigGameRematchingPhase5 (aggMap1Phase3,aggMap2Phase3)) rematchTypeIdsPhase5
  let aggMap1Phase5 = unions $ fmap fst qTablesMapPhase5
      aggMap2Phase5 = unions $ fmap snd qTablesMapPhase5
  mapM_ (rematchedLearning ("_phase6_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase6 exportConfigGameRematchingPhase6 (aggMap1Phase5,aggMap2Phase5)) rematchTypeIdsPhase6
