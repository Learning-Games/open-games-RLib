...
module Examples.QLearning.AsymmetricLearners.InternalEightPhases
  where
...
------------------------------------------------------------------------------------
-- NOTE: This version contains the run specification for 8 rematches with one player
-- This is written from the perspective of player 1 with one specific cost level
...
executeAndRematchSingleRun name  exportConfigGameLearning parametersMap keepOnlyNLastIterations parametersGameRematchingMap parametersGameRematchingMapPhase3 parametersGameRematchingMapPhase5 parametersGameRematchingMapPhase7 parametersGameRematchingMapPhase9 parametersGameRematchingMapPhase11 parametersGameRematchingMapPhase13 parametersGameRematchingMapPhase15  exportConfigGameRematchingPhase exportConfigGameRematchingRelearning  expIds rematchTypeIdsPhase rematchTypeIdsPhase3  rematchTypeIdsPhase5 rematchTypeIdsPhase7 rematchTypeIdsPhase9 rematchTypeIdsPhase11 rematchTypeIdsPhase13 rematchTypeIdsPhase15 = do
  ...
  mapM_ (rematchedLearning ("_phase2_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematchingPhase (aggMap1Phase1,aggMap2Phase1)) rematchTypeIdsPhase
  -- ^ Rematch player 1 from costlevel 4 with all other players including himself
  qTablesMapPhase3 <- mapM (rematchedLearningWithName ("_phase3_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase3 exportConfigGameRematchingRelearning (aggMap1Phase1,aggMap2Phase1) "e4") rematchTypeIdsPhase3
  let aggMap1Phase3 = unions $ fmap fst qTablesMapPhase3
  -- ^ Rerun setting with player 1 and player 2 cost level 1
  mapM_ (rematchedLearning ("_phase4_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematchingPhase (aggMap1Phase3,aggMap2Phase1)) rematchTypeIdsPhase
  -- ^ Rematch player 1 from costlevel 4 with all other players including himself
  qTablesMapPhase5 <- mapM (rematchedLearningWithName ("_phase5_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase5 exportConfigGameRematchingRelearning (aggMap1Phase1,aggMap2Phase1) "e4") rematchTypeIdsPhase5
  let aggMap1Phase5 = unions $ fmap fst qTablesMapPhase5
  -- ^ Rerun setting with player 1 and player 2 cost level 2
  mapM_ (rematchedLearning ("_phase6_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematchingPhase (aggMap1Phase5,aggMap2Phase1)) rematchTypeIdsPhase
   -- ^ Rematch player 1 from costlevel 4 with all other players including himself
  qTablesMapPhase7 <- mapM (rematchedLearningWithName ("_phase7_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase7 exportConfigGameRematchingRelearning (aggMap1Phase1,aggMap2Phase1) "e4") rematchTypeIdsPhase7
  let aggMap1Phase7 = unions $ fmap fst qTablesMapPhase7
  -- ^ Rerun setting with player 1 and player 2 cost level 3
  mapM_ (rematchedLearning ("_phase8_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematchingPhase (aggMap1Phase7,aggMap2Phase1)) rematchTypeIdsPhase
  -- ^ Rematch player 1 from costlevel 4 with all other players including himself
  qTablesMapPhase9 <- mapM (rematchedLearningWithName ("_phase9_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase9 exportConfigGameRematchingRelearning (aggMap1Phase1,aggMap2Phase1) "e4") rematchTypeIdsPhase9
  let aggMap1Phase9 = unions $ fmap fst qTablesMapPhase9
  -- ^ Rerun setting with player 1 and player 2 cost level 5
  mapM_ (rematchedLearning ("_phase10_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematchingPhase (aggMap1Phase9,aggMap2Phase1)) rematchTypeIdsPhase
  -- ^ Rematch player 1 from costlevel 4 with all other players including himself
  qTablesMapPhase11 <- mapM (rematchedLearningWithName ("_phase11_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase11 exportConfigGameRematchingRelearning (aggMap1Phase1,aggMap2Phase1) "e4") rematchTypeIdsPhase11
  let aggMap1Phase11 = unions $ fmap fst qTablesMapPhase11
  -- ^ Rerun setting with player 1 and player 2 cost level 6
  mapM_ (rematchedLearning ("_phase12_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematchingPhase (aggMap1Phase11,aggMap2Phase1)) rematchTypeIdsPhase
  -- ^ Rematch player 1 from costlevel 4 with all other players including himself
  qTablesMapPhase13 <- mapM (rematchedLearningWithName ("_phase13_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase13 exportConfigGameRematchingRelearning (aggMap1Phase1,aggMap2Phase1) "e4") rematchTypeIdsPhase13
  let aggMap1Phase13 = unions $ fmap fst qTablesMapPhase13
  -- ^ Rerun setting with player 1 and player 2 cost level 7
  mapM_ (rematchedLearning ("_phase14_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematchingPhase (aggMap1Phase13,aggMap2Phase1)) rematchTypeIdsPhase
  -- ^ Rematch player 1 from costlevel 4 with all other players including himself
  qTablesMapPhase15 <- mapM (rematchedLearningWithName ("_phase15_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMapPhase15 exportConfigGameRematchingRelearning (aggMap1Phase1,aggMap2Phase1) "e4") rematchTypeIdsPhase15
  let aggMap1Phase15 = unions $ fmap fst qTablesMapPhase15
  -- ^ Rerun setting with player 1 and player 2 cost level 8
  mapM_ (rematchedLearning ("_phase16_run_" ++ name) keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematchingPhase (aggMap1Phase15,aggMap2Phase1)) rematchTypeIdsPhase
  -- ^ Rematch player 1 from costlevel 4 with all other players including himself
...
rematchedLearningWithName :: String
                    ...
                    -> IO (Map String ((QTable
                              ...
                              , Map String ((QTable
                                          Player2N Observation PriceSpace), Observation PriceSpace))
rematchedLearningWithName name keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematching (qTablesMap1,qTablesMap2) targetName rematchType@ReMatchType{..}  = do
