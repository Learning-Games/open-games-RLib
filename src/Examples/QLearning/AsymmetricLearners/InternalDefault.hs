...
module Examples.QLearning.AsymmetricLearners.InternalDefault
  where
...
------------------------
-- For a specific experiment string produce the q table map 
...
rematchedLearning name keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematching qTablesMap ids =
  mapM_ (rematchedLearningId name keepOnlyNLastIterations parametersGameRematchingMap exportConfigGameRematching qTablesMap) ids
