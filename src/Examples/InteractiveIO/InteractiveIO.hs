...
------------------------------------------------------------------------
-- EXPERIMENTAL: Implement a simple interactive game, where through IO
-- the user supplies action information, and these actions are evaluated
-- accordingly. This game is also experimentally integrated with the
