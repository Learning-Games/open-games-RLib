...
Build an image with the source in it:
    ...
    docker image build -f pzahn/learning/src.Dockerfile -t ghcr.io/philipp-zahn/learning/src:2021-06-16 .

Build a base image with stack and haskell dependencies in it:

    docker image build -f pzahn/learning/base.Dockerfile -t ghcr.io/philipp-zahn/learning/base:2021-06-16 pzahn/

Building the final image for running:

    docker image build -f pzahn/learning/final.Dockerfile . -t ghcr.io/philipp-zahn/learning/final:2021-06-16

   
OK, now you can upload everything:

    docker push ghcr.io/philipp-zahn/learning/src:2021-06-16
    docker push ghcr.io/philipp-zahn/learning/base:2021-06-16
    docker push ghcr.io/philipp-zahn/learning/final:2021-06-16
...
```
root@Debian-109-buster-64-LAMP ~ # docker run -d --rm  -v/tmp/learning-watch:/tmp/learning-watch  -v/root/learning-work:/root/learning-work  ghcr.io/philipp-zahn/learning/final:2021-06-16  stack run watch
